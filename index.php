...
$sqlFilms = "SELECT idf, title, director, filename FROM film WHERE idu = ?";
...
<main> 
	<section class="sekcja1">	
		<div class="container-fluid">
			...
			<h4>Twoje filmy</h4>
			<a href="select.php" class="btn btn-primary mb-3">Dodaj film</a>
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="video.php?idf=<?php echo $row['idf']; ?>" class="btn btn-success btn-sm">Odtwórz</a>
						</td>
					</tr>
					<?php endwhile; ?>
				</tbody>
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if ($pl['idu'] == $idu): ?>
								<a href="add_to_playlist.php?idpl=<?php echo $pl['idpl']; ?>" class="btn btn-primary btn-sm mt-1">Dodaj filmy</a>
							<?php else: ?>
